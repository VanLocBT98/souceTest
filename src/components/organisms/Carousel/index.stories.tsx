...
import bannerImg from 'assets/images/carousel/bg.png';
...
const settingBanner = {
  ...
  slidesToScroll: 1,
  arrows: true,
  prevArrow: <PrevArrow extendClassName="banner" customArrow="defaultArrow" />,
  nextArrow: <NextArrow extendClassName="banner" customArrow="defaultArrow" />,
  infinite: false,
  cssEase: 'ease-in-out',
};
